...
func NewSysDictItemModel(conn sqlx.SqlConn, c cache.CacheConf, opts ...cache.Option) SysDictItemModel {
	return &customSysDictItemModel{
		defaultSysDictItemModel: newSysDictItemModel(conn, c, opts...),
	}
}
