...
func NewSysRolePermissionModel(conn sqlx.SqlConn, c cache.CacheConf, opts ...cache.Option) SysRolePermissionModel {
	return &customSysRolePermissionModel{
		defaultSysRolePermissionModel: newSysRolePermissionModel(conn, c, opts...),
	}
}
