...
type (
	...
	defaultSysRoleService struct {
		cli zrpc.Client
	}
)

func NewSysRoleService(cli zrpc.Client) SysRoleService {
	return &defaultSysRoleService{
		cli: cli,
	}
}

// -----------------------角色表-----------------------
func (m *defaultSysRoleService) AddSysRole(ctx context.Context, in *AddSysRoleReq, opts ...grpc.CallOption) (*AddSysRoleResp, error) {
	client := pb.NewSysRoleServiceClient(m.cli.Conn())
	return client.AddSysRole(ctx, in, opts...)
}

func (m *defaultSysRoleService) UpdateSysRole(ctx context.Context, in *UpdateSysRoleReq, opts ...grpc.CallOption) (*UpdateSysRoleResp, error) {
	client := pb.NewSysRoleServiceClient(m.cli.Conn())
	return client.UpdateSysRole(ctx, in, opts...)
}

func (m *defaultSysRoleService) DelSysRole(ctx context.Context, in *DelSysRoleReq, opts ...grpc.CallOption) (*DelSysRoleResp, error) {
	client := pb.NewSysRoleServiceClient(m.cli.Conn())
	return client.DelSysRole(ctx, in, opts...)
}

func (m *defaultSysRoleService) GetSysRoleById(ctx context.Context, in *GetSysRoleByIdReq, opts ...grpc.CallOption) (*GetSysRoleByIdResp, error) {
	client := pb.NewSysRoleServiceClient(m.cli.Conn())
	return client.GetSysRoleById(ctx, in, opts...)
}

func (m *defaultSysRoleService) SearchSysRole(ctx context.Context, in *SearchSysRoleReq, opts ...grpc.CallOption) (*SearchSysRoleResp, error) {
	client := pb.NewSysRoleServiceClient(m.cli.Conn())
	return client.SearchSysRole(ctx, in, opts...)
}

func (m *defaultSysRoleService) BindRolePermission(ctx context.Context, in *BindRolePermissionReq, opts ...grpc.CallOption) (*BindRolePermissionResp, error) {
	client := pb.NewSysRoleServiceClient(m.cli.Conn())
	return client.BindRolePermission(ctx, in, opts...)
}

func (m *defaultSysRoleService) SearchRolePermission(ctx context.Context, in *SearchRolePermissionReq, opts ...grpc.CallOption) (*SearchRolePermissionResp, error) {
	client := pb.NewSysRoleServiceClient(m.cli.Conn())
	return client.SearchRolePermission(ctx, in, opts...)
}

func (m *defaultSysRoleService) BindRoleMenu(ctx context.Context, in *BindRoleMenuReq, opts ...grpc.CallOption) (*BindRoleMenuResp, error) {
	client := pb.NewSysRoleServiceClient(m.cli.Conn())
	return client.BindRoleMenu(ctx, in, opts...)
}

func (m *defaultSysRoleService) SearchRoleMenu(ctx context.Context, in *SearchRoleMenuReq, opts ...grpc.CallOption) (*SearchRoleMenuResp, error) {
	client := pb.NewSysRoleServiceClient(m.cli.Conn())
	return client.SearchRoleMenu(ctx, in, opts...)
}

func (m *defaultSysRoleService) SearchRolePermissionIds(ctx context.Context, in *SearchRolePermissionIdsReq, opts ...grpc.CallOption) (*SearchRolePermissionIdsResp, error) {
	client := pb.NewSysRoleServiceClient(m.cli.Conn())
	return client.SearchRolePermissionIds(ctx, in, opts...)
}
