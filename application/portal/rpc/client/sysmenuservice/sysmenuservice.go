...
type (
	...
	defaultSysMenuService struct {
		cli zrpc.Client
	}
)

func NewSysMenuService(cli zrpc.Client) SysMenuService {
	return &defaultSysMenuService{
		cli: cli,
	}
}

// -----------------------菜单表-----------------------
func (m *defaultSysMenuService) AddSysMenu(ctx context.Context, in *AddSysMenuReq, opts ...grpc.CallOption) (*AddSysMenuResp, error) {
	client := pb.NewSysMenuServiceClient(m.cli.Conn())
	return client.AddSysMenu(ctx, in, opts...)
}

func (m *defaultSysMenuService) UpdateSysMenu(ctx context.Context, in *UpdateSysMenuReq, opts ...grpc.CallOption) (*UpdateSysMenuResp, error) {
	client := pb.NewSysMenuServiceClient(m.cli.Conn())
	return client.UpdateSysMenu(ctx, in, opts...)
}

func (m *defaultSysMenuService) DelSysMenu(ctx context.Context, in *DelSysMenuReq, opts ...grpc.CallOption) (*DelSysMenuResp, error) {
	client := pb.NewSysMenuServiceClient(m.cli.Conn())
	return client.DelSysMenu(ctx, in, opts...)
}

func (m *defaultSysMenuService) GetSysMenuById(ctx context.Context, in *GetSysMenuByIdReq, opts ...grpc.CallOption) (*GetSysMenuByIdResp, error) {
	client := pb.NewSysMenuServiceClient(m.cli.Conn())
	return client.GetSysMenuById(ctx, in, opts...)
}

func (m *defaultSysMenuService) SearchSysMenu(ctx context.Context, in *SearchSysMenuReq, opts ...grpc.CallOption) (*SearchSysMenuResp, error) {
	client := pb.NewSysMenuServiceClient(m.cli.Conn())
	return client.SearchSysMenu(ctx, in, opts...)
}

// 新增接口：获取菜单树
func (m *defaultSysMenuService) GetMenuTree(ctx context.Context, in *GetMenuTreeReq, opts ...grpc.CallOption) (*GetMenuTreeResp, error) {
	client := pb.NewSysMenuServiceClient(m.cli.Conn())
