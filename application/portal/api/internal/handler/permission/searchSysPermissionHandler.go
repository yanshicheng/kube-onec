...
func SearchSysPermissionHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchSysPermissionRequest
		...
		l := permission.NewSearchSysPermissionLogic(r.Context(), svcCtx)
		resp, err := l.SearchSysPermission(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
