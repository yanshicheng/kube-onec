...
func UpdateSysPermissionHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateSysPermissionRequest
		...
		l := permission.NewUpdateSysPermissionLogic(r.Context(), svcCtx)
		resp, err := l.UpdateSysPermission(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
