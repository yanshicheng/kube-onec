...
func GetSysPermissionByIdHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := permission.NewGetSysPermissionByIdLogic(r.Context(), svcCtx)
		resp, err := l.GetSysPermissionById(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
