...
func DelSysPermissionHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := permission.NewDelSysPermissionLogic(r.Context(), svcCtx)
		resp, err := l.DelSysPermission(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
