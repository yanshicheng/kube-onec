...
func UpdateSysDictItemHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateSysDictItemRequest
		...
		l := dictItem.NewUpdateSysDictItemLogic(r.Context(), svcCtx)
		resp, err := l.UpdateSysDictItem(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
