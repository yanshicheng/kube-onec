...
func DeleteSysDictItemHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := dictItem.NewDeleteSysDictItemLogic(r.Context(), svcCtx)
		resp, err := l.DeleteSysDictItem(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
