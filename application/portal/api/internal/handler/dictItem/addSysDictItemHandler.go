...
func AddSysDictItemHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AddSysDictItemRequest
		...
		l := dictItem.NewAddSysDictItemLogic(r.Context(), svcCtx)
		resp, err := l.AddSysDictItem(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
