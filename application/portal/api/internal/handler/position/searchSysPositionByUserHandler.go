...
func SearchSysPositionByUserHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := position.NewSearchSysPositionByUserLogic(r.Context(), svcCtx)
		resp, err := l.SearchSysPositionByUser(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
