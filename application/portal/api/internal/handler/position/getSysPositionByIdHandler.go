...
func GetSysPositionByIdHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := position.NewGetSysPositionByIdLogic(r.Context(), svcCtx)
		resp, err := l.GetSysPositionById(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
