...
func AddSysPositionHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AddSysPositionRequest
		...
		l := position.NewAddSysPositionLogic(r.Context(), svcCtx)
		resp, err := l.AddSysPosition(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
