...
func SearchSysPositionHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchSysPositionRequest
		...
		l := position.NewSearchSysPositionLogic(r.Context(), svcCtx)
		resp, err := l.SearchSysPosition(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
