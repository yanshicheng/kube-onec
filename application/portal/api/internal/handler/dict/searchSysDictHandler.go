...
import (
	...
	"github.com/yanshicheng/kube-onec/application/portal/api/internal/logic/dict"
...
func SearchSysDictHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchSysDictRequest
		...
		l := dict.NewSearchSysDictLogic(r.Context(), svcCtx)
		resp, err := l.SearchSysDict(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
