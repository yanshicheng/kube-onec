...
func UpdateSysDictHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateSysDictRequest
		...
		l := dict.NewUpdateSysDictLogic(r.Context(), svcCtx)
		resp, err := l.UpdateSysDict(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
