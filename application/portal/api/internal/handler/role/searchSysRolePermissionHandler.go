...
import (
	...
	"github.com/yanshicheng/kube-onec/application/portal/api/internal/logic/role"
...
func SearchSysRolePermissionHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchSysRolePermissionRequest
		...
		l := role.NewSearchSysRolePermissionLogic(r.Context(), svcCtx)
		resp, err := l.SearchSysRolePermission(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
