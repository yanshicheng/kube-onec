...
func SearchSysRoleHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchSysRoleRequest
		...
		l := role.NewSearchSysRoleLogic(r.Context(), svcCtx)
		resp, err := l.SearchSysRole(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
