...
func BindSysRolePermissionHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.BindSysRolePermissionRequest
		...
		l := role.NewBindSysRolePermissionLogic(r.Context(), svcCtx)
		resp, err := l.BindSysRolePermission(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
