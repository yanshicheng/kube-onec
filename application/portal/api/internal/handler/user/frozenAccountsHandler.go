...
func FrozenAccountsHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.FrozenAccountsRequest
		...
		l := user.NewFrozenAccountsLogic(r.Context(), svcCtx)
		resp, err := l.FrozenAccounts(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
