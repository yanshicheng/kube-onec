...
func SearchSysUserHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchSysUserRequest
		...
		l := user.NewSearchSysUserLogic(r.Context(), svcCtx)
		resp, err := l.SearchSysUser(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
