...
func SearchBindUserHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchBindUserRequest
		...
		l := user.NewSearchBindUserLogic(r.Context(), svcCtx)
		resp, err := l.SearchBindUser(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
