...
func SearchSysOrganizationHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchSysOrganizationRequest
		...
		l := organization.NewSearchSysOrganizationLogic(r.Context(), svcCtx)
		resp, err := l.SearchSysOrganization(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
