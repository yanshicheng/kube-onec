...
func DelSysOrganizationHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := organization.NewDelSysOrganizationLogic(r.Context(), svcCtx)
		resp, err := l.DelSysOrganization(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
