...
import (
	...
	"github.com/yanshicheng/kube-onec/application/portal/api/internal/logic/organization"
...
func UpdateSysOrganizationHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateSysOrganizationRequest
		...
		l := organization.NewUpdateSysOrganizationLogic(r.Context(), svcCtx)
		resp, err := l.UpdateSysOrganization(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
