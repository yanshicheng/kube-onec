...
func AddSysOrganizationHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AddSysOrganizationRequest
		...
		l := organization.NewAddSysOrganizationLogic(r.Context(), svcCtx)
		resp, err := l.AddSysOrganization(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
