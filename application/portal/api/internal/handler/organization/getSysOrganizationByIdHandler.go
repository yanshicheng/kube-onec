...
func GetSysOrganizationByIdHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := organization.NewGetSysOrganizationByIdLogic(r.Context(), svcCtx)
		resp, err := l.GetSysOrganizationById(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
