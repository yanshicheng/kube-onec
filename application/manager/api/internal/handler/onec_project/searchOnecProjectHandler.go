...
func SearchOnecProjectHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchOnecProjectRequest
		...
		l := onec_project.NewSearchOnecProjectLogic(r.Context(), svcCtx)
		resp, err := l.SearchOnecProject(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
