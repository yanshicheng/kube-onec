...
func AddOnecProjectHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AddOnecProjectRequest
		...
		l := onec_project.NewAddOnecProjectLogic(r.Context(), svcCtx)
		resp, err := l.AddOnecProject(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
