...
func UpdateOnecProjectQuotaHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateOnecProjectQuotaRequest
		...
		l := onec_project.NewUpdateOnecProjectQuotaLogic(r.Context(), svcCtx)
		resp, err := l.UpdateOnecProjectQuota(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
