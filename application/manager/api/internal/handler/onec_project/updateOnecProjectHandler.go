...
func UpdateOnecProjectHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateOnecProjectRequest
		...
		l := onec_project.NewUpdateOnecProjectLogic(r.Context(), svcCtx)
		resp, err := l.UpdateOnecProject(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
