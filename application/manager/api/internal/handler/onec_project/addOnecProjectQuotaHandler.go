...
func AddOnecProjectQuotaHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AddOnecProjectQuotaRequest
		...
		l := onec_project.NewAddOnecProjectQuotaLogic(r.Context(), svcCtx)
		resp, err := l.AddOnecProjectQuota(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
