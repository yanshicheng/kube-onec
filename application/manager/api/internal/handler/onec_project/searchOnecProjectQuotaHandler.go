...
func SearchOnecProjectQuotaHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchOnecProjectQuotaRequest
		...
		l := onec_project.NewSearchOnecProjectQuotaLogic(r.Context(), svcCtx)
		resp, err := l.SearchOnecProjectQuota(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
