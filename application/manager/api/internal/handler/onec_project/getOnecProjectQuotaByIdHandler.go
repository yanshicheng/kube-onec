...
func GetOnecProjectQuotaByIdHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := onec_project.NewGetOnecProjectQuotaByIdLogic(r.Context(), svcCtx)
		resp, err := l.GetOnecProjectQuotaById(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
