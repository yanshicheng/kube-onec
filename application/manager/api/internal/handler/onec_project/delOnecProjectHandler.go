...
func DelOnecProjectHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := onec_project.NewDelOnecProjectLogic(r.Context(), svcCtx)
		resp, err := l.DelOnecProject(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
