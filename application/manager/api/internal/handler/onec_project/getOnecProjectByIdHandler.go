...
func GetOnecProjectByIdHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := onec_project.NewGetOnecProjectByIdLogic(r.Context(), svcCtx)
		resp, err := l.GetOnecProjectById(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
