...
func DelOnecNodeHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DelOnecNodeRequest
		...
		l := node.NewDelOnecNodeLogic(r.Context(), svcCtx)
		resp, err := l.DelOnecNode(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
