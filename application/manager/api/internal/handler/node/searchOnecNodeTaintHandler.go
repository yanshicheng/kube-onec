...
func SearchOnecNodeTaintHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchNodeTaintsRequest
		...
		l := node.NewSearchOnecNodeTaintLogic(r.Context(), svcCtx)
		resp, err := l.SearchOnecNodeTaint(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
