...
func AddOnecNodeLabelHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AddOnecNodeLabelRequest
		...
		l := node.NewAddOnecNodeLabelLogic(r.Context(), svcCtx)
		resp, err := l.AddOnecNodeLabel(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
