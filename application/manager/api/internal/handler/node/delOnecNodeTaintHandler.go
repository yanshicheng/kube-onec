...
func DelOnecNodeTaintHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DelOnecNodeTaintRequest
		...
		l := node.NewDelOnecNodeTaintLogic(r.Context(), svcCtx)
		resp, err := l.DelOnecNodeTaint(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
