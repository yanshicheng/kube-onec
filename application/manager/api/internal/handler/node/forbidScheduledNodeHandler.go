...
func ForbidScheduledNodeHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ForbidScheduledRequest
		...
		l := node.NewForbidScheduledNodeLogic(r.Context(), svcCtx)
		resp, err := l.ForbidScheduledNode(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
