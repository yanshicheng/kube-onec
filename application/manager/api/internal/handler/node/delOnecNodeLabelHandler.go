...
func DelOnecNodeLabelHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.DelOnecNodeLabelRequest
		...
		l := node.NewDelOnecNodeLabelLogic(r.Context(), svcCtx)
		resp, err := l.DelOnecNodeLabel(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
