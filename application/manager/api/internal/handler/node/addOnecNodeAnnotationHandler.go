...
func AddOnecNodeAnnotationHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AddOnecNodeAnnotationRequest
		...
		l := node.NewAddOnecNodeAnnotationLogic(r.Context(), svcCtx)
		resp, err := l.AddOnecNodeAnnotation(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
