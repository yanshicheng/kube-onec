...
func EnableScheduledNodeHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.EnableScheduledRequest
		...
		l := node.NewEnableScheduledNodeLogic(r.Context(), svcCtx)
		resp, err := l.EnableScheduledNode(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
