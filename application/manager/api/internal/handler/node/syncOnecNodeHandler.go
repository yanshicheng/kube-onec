...
func SyncOnecNodeHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SyncOnecNodeRequest
		...
		l := node.NewSyncOnecNodeLogic(r.Context(), svcCtx)
		resp, err := l.SyncOnecNode(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
