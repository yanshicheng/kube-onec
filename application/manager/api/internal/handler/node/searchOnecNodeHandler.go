...
func SearchOnecNodeHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchOnecNodeRequest
		...
		l := node.NewSearchOnecNodeLogic(r.Context(), svcCtx)
		resp, err := l.SearchOnecNode(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
