...
func AddOnecNodeTaintHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AddOnecNodeTaintRequest
		...
		l := node.NewAddOnecNodeTaintLogic(r.Context(), svcCtx)
		resp, err := l.AddOnecNodeTaint(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
