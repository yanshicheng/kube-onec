...
func UpdateOnecClusterConnInfoHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateOnecClusterConnInfoRequest
		...
		l := cluster.NewUpdateOnecClusterConnInfoLogic(r.Context(), svcCtx)
		resp, err := l.UpdateOnecClusterConnInfo(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
