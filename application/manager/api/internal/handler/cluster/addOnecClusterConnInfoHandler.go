...
func AddOnecClusterConnInfoHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AddOnecClusterConnInfoRequest
		...
		l := cluster.NewAddOnecClusterConnInfoLogic(r.Context(), svcCtx)
		resp, err := l.AddOnecClusterConnInfo(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
