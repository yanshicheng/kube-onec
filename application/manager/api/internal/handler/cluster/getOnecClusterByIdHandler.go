...
func GetOnecClusterByIdHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := cluster.NewGetOnecClusterByIdLogic(r.Context(), svcCtx)
		resp, err := l.GetOnecClusterById(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
