...
func DelOnecClusterConnInfoHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := cluster.NewDelOnecClusterConnInfoLogic(r.Context(), svcCtx)
		resp, err := l.DelOnecClusterConnInfo(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
