...
func AddOnecNodeHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AddOnecNodeRequest
		...
		l := cluster.NewAddOnecNodeLogic(r.Context(), svcCtx)
		resp, err := l.AddOnecNode(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
