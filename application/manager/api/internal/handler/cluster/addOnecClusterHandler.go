...
func AddOnecClusterHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.AddOnecClusterRequest
		...
		l := cluster.NewAddOnecClusterLogic(r.Context(), svcCtx)
		resp, err := l.AddOnecCluster(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
