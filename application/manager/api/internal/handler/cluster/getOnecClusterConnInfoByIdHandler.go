...
func GetOnecClusterConnInfoByIdHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		l := cluster.NewGetOnecClusterConnInfoByIdLogic(r.Context(), svcCtx)
		resp, err := l.GetOnecClusterConnInfoById(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
