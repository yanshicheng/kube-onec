...
func UpdateOnecClusterHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.UpdateOnecClusterRequest
		...
		l := cluster.NewUpdateOnecClusterLogic(r.Context(), svcCtx)
		resp, err := l.UpdateOnecCluster(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
