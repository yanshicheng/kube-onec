...
func SearchOnecClusterConnInfoHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchOnecClusterConnInfoRequest
		...
		l := cluster.NewSearchOnecClusterConnInfoLogic(r.Context(), svcCtx)
		resp, err := l.SearchOnecClusterConnInfo(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
