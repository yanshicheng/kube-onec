...
func SearchOnecClusterHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SearchOnecClusterRequest
		...
		l := cluster.NewSearchOnecClusterLogic(r.Context(), svcCtx)
		resp, err := l.SearchOnecCluster(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
